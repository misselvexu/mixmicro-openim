...
import com.acmedcare.framework.newim.server.master.connector.MasterConnectorContext;
...
public class MasterNoticeClientChannelsRequestProcessor implements NettyRequestProcessor {
  ...
  public MasterNoticeClientChannelsRequestProcessor(MasterConnectorContext masterConnectorContext) {
    this.context = masterConnectorContext;
  }
