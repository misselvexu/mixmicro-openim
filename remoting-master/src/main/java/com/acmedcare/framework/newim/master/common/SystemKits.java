 ...
 */
package com.acmedcare.framework.newim.master.common;
...
public class SystemKits {
  ...
  public static final String NEWIM_MASTER_HOME_KEY = "newim.master.home";

  public static final String NEWIM_MASTER_LOCAL_IP_KEY = "NEWIM_MASTER_LOCAL_IP";

  public static final String LOCAL_IP = getHostAddress();

  public static final String NEWIM_MASTER_HOME = getMasterHome();
  ...
  private static String getMasterHome() {
    String home = System.getProperty(NEWIM_MASTER_HOME_KEY);
    if (StringUtils.isBlank(home)) {
      home = System.getProperty("user.home") + File.separator + "newim.master";
    }
    return home;
  }
}
