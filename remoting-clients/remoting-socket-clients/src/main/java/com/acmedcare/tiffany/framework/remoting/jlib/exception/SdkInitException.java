package com.acmedcare.tiffany.framework.remoting.jlib.exception;
 ...
 */
public class SdkInitException extends Throwable {
   ...
   */
  public SdkInitException(String message) {
    super(message);
  }
   ...
   * @since 1.4
   */
  public SdkInitException(String message, Throwable cause) {
    super(message, cause);
  }
}
