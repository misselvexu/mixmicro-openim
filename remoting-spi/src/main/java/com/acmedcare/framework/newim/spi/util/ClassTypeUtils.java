 ...
 * 类型转换工具类
 *
 * <p>调用端时将类描述转换为字符串传输。服务端将字符串转换为具体的类
 *
 * <pre>
 *     保证传递的时候值为可阅读格式，而不是jvm格式（[Lxxx;）：
 *     普通：java.lang.String、java.lang.String[]
 *     基本类型：int、int[]
 *     内部类：com.acmedcare.example.Inner、com.acmedcare.example.Inner[]
 *     匿名类：com.acmedcare.example.Xxx$1、com.acmedcare.example.Xxx$1[]
 *     本地类：com.acmedcare.example.Xxx$1Local、com.acmedcare.example.Xxx$1Local[]
 *     成员类：com.acmedcare.example.Xxx$Member、com.acmedcare.example.Xxx$Member[]
...
public class ClassTypeUtils {
   ...
   * @return Class[]
   */
  public static Class[] getClasses(String[] typeStrs) throws SpiException {
  ...
  public static Class getClass(String typeStr) {
    Class clazz = getClassCache(typeStr);
    if (clazz == null) {
